 ...
 * @author mombaye
 *
 * Classe de Tests des services de gestion des taxes
 */
public class TaxeServiceTest extends AbstractCommonTest {
	...
	public void loadTaxeByDateNullTest() {
		...
		thrown.expectMessage(FunctionalErrorMessageConstants.ERREUR_PARAMETRAGE_DATE_NULL);
		
		//Call
		taxeService.loadTaxeByDate(null);
	}
	...
	public void loadTaxeByDateNoResultFoundTest() {
		...
		//Appel
		taxeService.loadTaxeByDate(paramDate);
	}
	...
	public void loadTaxeByDateTest() {
		...
		LocalDateTime paramDate = CustomDateUtil.DD_MM_YYYY.parseLocalDateTime(date);
		//Appel
		Taxe taxe = taxeService.loadTaxeByDate(paramDate);
